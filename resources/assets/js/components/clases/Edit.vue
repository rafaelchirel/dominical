                          ...
                          <form @submit.prevent="update">
                              ...
                              <div class="clearfix"></div>
                               ...
                               <div class="text-center" style="margin-top: 4%;">
                                  ...
                                  <button type="submit" class="btn btn-info" :disabled="grupoCount">Actualizar</button>
                               </div>
...
export default {
	...
	methods:{
		getClase: function () {
	        ...
	        var urlApiURL = Const.apiURL + '/clase/' + id + '/edit';
	          axios.get(urlApiURL).then(response => {
	              this.clase = response.data;
	              this.clase.turno_facilitador = ''
	              this.clase.hora_entrada = this.clase.fecha + "T" + this.clase.hora_entrada  + ".000-04:00"
	              this.clase.hora_salida = this.clase.fecha + "T" + this.clase.hora_salida  + ".000-04:00"
	          });
	    },
		update: function () {
          var url    = Const.apiURL + '/clase/' + this.clase.id;
          axios.put(url, this.clase).then(response => {
